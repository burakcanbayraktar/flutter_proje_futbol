...
import 'package:flutter_proje/haftalar/hafta31.dart';
import 'package:flutter_proje/haftalar/hafta33.dart';
...
class hafta32 extends StatefulWidget {

  

  @override
  State<hafta32> createState() => _hafta32();
}

class _hafta32 extends State<hafta32> {
  @override
    ...
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.pink,title: Row(
             ...
             IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hafta31()));
                },
              ),
                  Image.asset(
                 'assets/liglogo.png',
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hafta33()));
                },
              ),
              ],
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //12
                      child: Text("Brighton", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
                    ...
                    Container(
                      child: Text(" 0-0 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 0-2 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 1-4 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 1-1 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 5-1 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Crystal Pal", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
