...
import 'package:flutter_proje/haftalar/hafta29.dart';
...
class hafta30 extends StatefulWidget {
  const hafta30({ Key? key }) : super(key: key);

  @override
  State<hafta30> createState() => _hafta30();
}

class _hafta30 extends State<hafta30> {
  @override
     ...
     return Scaffold(
      appBar: AppBar(backgroundColor: Colors.pink,title: Row(
             ...
             IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hafta29()));
                },
              ),
                  Image.asset(
                 'assets/liglogo.png',
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //12
                      child: Text("Brentford", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 3-2 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Everton", style: TextStyle(color:Colors.grey, fontSize: 16,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
