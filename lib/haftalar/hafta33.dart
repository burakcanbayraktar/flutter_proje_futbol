...
import 'package:flutter_proje/haftalar/hafta34.dart';
...
class hafta33 extends StatefulWidget {
  

  @override
  State<hafta33> createState() => _hafta33();
}

class _hafta33 extends State<hafta33> {
  @override
      ...
      appBar: AppBar(backgroundColor: Colors.pink,title: Row(
             ...
             IconButton(
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hafta34()));
                },
              ),
              ],
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text("Man. United", style: TextStyle(color:Colors.grey, fontSize: 20,fontWeight: FontWeight.bold),),
                      width: 120,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 0-6 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Watford", style: TextStyle(color:Colors.grey, fontSize: 16,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Leicester", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 2-2 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
