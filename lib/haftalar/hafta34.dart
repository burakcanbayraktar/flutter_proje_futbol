...
class hafta34 extends StatefulWidget {


  @override
  State<hafta34> createState() => _hafta34();
}

class _hafta34 extends State<hafta34> {
  @override
   @override 
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Newcastle", style: TextStyle(color:Colors.grey, fontSize: 16,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Everton", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
