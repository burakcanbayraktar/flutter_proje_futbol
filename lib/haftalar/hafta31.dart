...
import 'package:flutter_proje/haftalar/hafta30.dart';
import 'package:flutter_proje/haftalar/hafta32.dart';
...
class hafta31 extends StatefulWidget {
  const hafta31({ Key? key }) : super(key: key);

  @override
  State<hafta31> createState() => _hafta31();
}

class _hafta31 extends State<hafta31> {
  @override
     ...
     return Scaffold(
      appBar: AppBar(backgroundColor: Colors.pink,title: Row(
             ...
             IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hafta30()));
                },
              ),
                  Image.asset(
                 'assets/liglogo.png',
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hafta32()));
                },
              ),
              ],
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 1-3 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //12
                      child: Text("Chelsea", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
                    ...
                    Container(
                      child: Text(" 2-3 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 2-1 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Tottenham", style: TextStyle(color:Colors.grey, fontSize: 16,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      child: Text(" 4-0 ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Man. City", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      //14
                      child: Text("Watford", style: TextStyle(color:Colors.grey, fontSize: 18,fontWeight: FontWeight.bold),),
                      width: 120,
                    ),
                    Container(
                    ...
                    Container(
                      child: Text("  -  ", style: TextStyle(color:Colors.white,backgroundColor:Colors.grey , fontSize: 15,fontWeight: FontWeight.bold),),
                      width: 30,
